...
var imgBgRandom=Math.floor(3*Math.random()+1);
switch(imgBgRandom){
case 1:
...
hum=consultaAireCDMX.current.humidity,
air=consultaAireCDMX.current.wind_kph+consultaAireCDMX.current.wind_dir,
jsonWetherData={
temp:temp,
place:place,
hum:hum,
