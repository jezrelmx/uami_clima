...
// in simulator we redefine to format for Clima_CDMX Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.clima_cdmx." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.clima_cdmx";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIClima_CDMXNativeItemNone = -1,
  UIClima_CDMXNativeItemSpinner = -2,
  UIClima_CDMXNativeItemProgressBar = -3,

  UIClima_CDMXNativeItemSlider = -4,
  UIClima_CDMXNativeItemSwitch = -5,
  UIClima_CDMXNativeItemMultiButton = -6,
  UIClima_CDMXNativeItemSegmented = -7,

  UIClima_CDMXNativeItemTextView = -8,
  UIClima_CDMXNativeItemTextField = -9,
  UIClima_CDMXNativeItemSearchBar = -10,

  UIClima_CDMXNativeItemPicker = -11,
  UIClima_CDMXNativeItemDatePicker = -12,

  UIClima_CDMXNativeItemInfoLight = -13,
  UIClima_CDMXNativeItemInfoDark = -14,

  UIClima_CDMXNativeItemDisclosure = -15,

  UIClima_CDMXNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Clima_CDMX instances of
