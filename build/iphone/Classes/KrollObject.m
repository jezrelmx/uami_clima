...
//@interface Clima_CDMXObject : NSObject
//@end

@interface Clima_CDMXObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
  ...
  if (o) {
    ...
    if ([o isKindOfClass:[Clima_CDMXObject class]]) {
      for (NSString *key in [[(Clima_CDMXObject *)o modules] allKeys]) {
