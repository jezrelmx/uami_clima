...
/**
 Base class for all Clima_CDMX views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Clima_CDMX view hierarchy (such as wrapped iOS UIViews) was touched.
