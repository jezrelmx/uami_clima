 ...
 * to send analytic data that can be viewed on the Clima_CDMX Dashboard.
 *
 * For information on getting started with Clima_CDMX Platform Services,
 * see [Clima_CDMX Platform Services for iOS](http://bit.ly/1kqteQS).
 */
