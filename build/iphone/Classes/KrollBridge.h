...
@interface Clima_CDMXObject : KrollCoverageObject {
#else
@interface Clima_CDMXObject : KrollObject {
#endif
  @private
...
extern NSString *Clima_CDMX$ModuleRequireFormat;
