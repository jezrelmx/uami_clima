...
/**
 The base class for all Clima_CDMX modules
 */
...
/**
 Clima_CDMX Platform calls this method on startup.
 */
- (void)startup;

/**
 Clima_CDMX Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
- (void)shutdown:(id)sender;

/**
 Clima_CDMX Platform calls this method on suspend.
 @param sender The sender of the event.
 */
- (void)suspend:(id)sender;

/**
 Clima_CDMX Platform calls this method on entering background.
 @param sender The sender of the event.
 */
- (void)paused:(id)sender;

/**
 Clima_CDMX Platform calls this method on resume.
 @param sender The sender of the event.
 */
